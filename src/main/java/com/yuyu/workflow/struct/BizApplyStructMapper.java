...
public interface BizApplyStructMapper {
     ...
     * 保存并提交参数转换为流程提交参数。
     */
    @Mapping(target = "bizApplyId", source = "bizApply.id")
    WorkflowBizSubmitETO toWorkflowBizSubmitETO(BizApplySaveAndSubmitETO eto, BizApply bizApply);


    BizApplySaveDraftETO toBizApplySaveDraftETO(BizApplySaveAndSubmitETO eto);
