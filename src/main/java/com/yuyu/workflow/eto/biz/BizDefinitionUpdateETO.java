...
@Schema(description = "修改业务定义参数")
public class BizDefinitionUpdateETO extends UserContextParam {

    @Schema(description = "业务定义ID", requiredMode = Schema.RequiredMode.REQUIRED)
